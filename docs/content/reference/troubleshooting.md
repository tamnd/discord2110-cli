...
Most of these come down to network reality or how discord2110 serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

discord2110 rate-limits like any public site. discord2110 already paces
...
Where a surface is gated, discord2110 reads a cookie or token you supply
...
`discord2110`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what discord2110 actually did
