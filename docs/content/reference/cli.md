...
```
discord2110 <command> [arguments] [flags]
```

Run `discord2110 <command> --help` for the full flag list on any command. This
...
per operation you declare in `discord2110/domain.go`.
